        ...
        <div class="panel panel-info">
          <div class="panel-heading">
            <div class="form-group row">
              <label for="q" class="col-md-2 control-label">Nombre de Abarrote</label>
              <div class="col-md-5">
              ...
              <a href="#" class='btn btn-default' title='Descargar factura' onclick="imprimir('<?php echo $sucursal;?>');"><i class="glyphicon glyphicon-download"></i></a> 

              <div class="col-md-3">
                <div class="btn-group pull-left">
                  <button type='button' class="btn btn-secundary" data-toggle="modal" data-target="#enviarProducto"><span class="glyphicon glyphicon-plus" ></span> Enviar</button>
                </div>
              </div>
            </div>
          </div>
