      ...
      <section class="content">
        ...
        <div class="panel panel-info">
          ...
          <div class="form-group row">
            <label for="q" class="col-md-2 control-label">Compra</label>
            <div class="col-md-5">
              <input type="text" class="form-control" id="q" placeholder="Nombre del proveedor o Numero de Factura" onkeyup='load(1);'>
            </div>
            <div class="col-md-3">
          ...
          <div class="btn-group pull-left">
            <a  href="nuevafactura.php?tipo=Proveedor" class="btn btn-primary"><span class="glyphicon glyphicon-plus" ></span> Nueva Compra</a>
          </div>
              </div>
            </div>
          </div>
        ...
        <form action="" method="post">
            ...
            ?>
            <p><input type="number" id="va" name="va" value="<?php echo $nom['pagina']; ?>" min="1" max="250">
