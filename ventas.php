      ...
      <section class="content">
        ...
        <div class="panel panel-info">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-5">
              <input type="text" class="form-control" id="q" placeholder="Nombre del cliente o Numero de Factura" onkeyup='load(1);'>
            </div>
            <div class="col-md-3">
          ...
          <div class="btn-group pull-left">
            <a  href="nuevafactura.php?tipo=Cliente" class="btn btn-primary"><span class="glyphicon glyphicon-plus" ></span> Nueva Venta</a>
          </div>
              </div>
            </div>
          </div>
